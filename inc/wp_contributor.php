<div class="avatar">
    ...
    &nbsp;<h1 class="role"><?php _e('Contributor' , 'wp_op'); ?></h1>
</div>
    ...
    <?php settings_fields( 'wp_information_settings_group_contributor' ); ?>
        <table class="form-table">
            <tr>
                ...
                value="<?php echo htmlentities(get_option('wp-info-name-contributor')); ?>" /></td>
            </tr>
