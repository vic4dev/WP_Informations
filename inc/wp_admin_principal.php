<div class="boite">
    <div class="avatar">
        <?php echo '<img src="' . plugins_url( '../library/img/admin.png', __FILE__ ) . '" > ';?>&nbsp;
    ...
    <table class="form-table">
        <tr>
            ...
            value="<?php echo htmlentities(get_option('wp-info-name-admin')); ?>" disabled='disabled' /></td>
        </tr>
        ...
        <tr>
            ...
            value="<?php echo htmlentities(get_option('wp-info-twitter-admin')); ?>" disabled='disabled' /></td>
        </tr>
        ...
        <tr>
            ...
            value="<?php echo htmlentities(get_option('wp-info-facebook-admin')); ?>" disabled='disabled' /></a></td>
        </tr>
         
        <tr>
            <th scope="row"><?php _e('Telephone number' , 'wp_op'); ?> :</th>
            <td><input class="wp_information_input" type="tel" name="wp-info-tel-admin" 
            value="<?php echo htmlentities(get_option('wp-info-tel-admin')); ?>" disabled='disabled' /></td>
        </tr>
        
        <tr>
            <th scope="row"><?php _e('Email' , 'wp_op'); ?> :</th>
            <td><input class="wp_information_input" type="email" name="wp-info-email-admin" 
            value="<?php echo htmlentities(get_option('wp-info-email-admin')); ?>" disabled='disabled' /></td>
        </tr>
    </table>
    <p>
