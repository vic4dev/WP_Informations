<div class="boite">
    ...
    <table class="form-table">
        <tr>
            ...
            value="<?php echo get_option('wp-info-name-editor'); ?>" disabled='disabled' /></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Username' , 'wp_op'); ?> @Twitter :</th>
            <td><input class="wp_information_input" type="text" name="wp-info-twitter-editor" 
            value="<?php echo get_option('wp-info-twitter-editor'); ?>" disabled='disabled' /></td>
        </tr>
        <tr>
