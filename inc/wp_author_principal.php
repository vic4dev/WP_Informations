<div class="boite">
    <div class="avatar">
        <?php echo '<img src="' . plugins_url( '../library/img/author.png', __FILE__ ) . '" > ';?>&nbsp;
    ...
    <table class="form-table">
        <tr>
            ...
            value="<?php echo htmlentities(get_option('wp-info-name-author')); ?>" disabled='disabled' /></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Username' , 'wp_op'); ?> @Twitter :</th>
            <td><input class="wp_information_input" type="text" name="wp-info-twitter-author" 
            value="<?php echo htmlentities(get_option('wp-info-twitter-author')); ?>" disabled='disabled' /></td>
        </tr>
        <tr>
            ...
            value="<?php echo htmlentities(get_option('wp-info-facebook-author')); ?>"disabled='disabled' /></a></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Telephone number' , 'wp_op'); ?> :</th>
            <td><input class="wp_information_input" type="tel" name="wp-info-tel-author" 
            value="<?php echo htmlentities(get_option('wp-info-tel-author')); ?>" disabled='disabled' /></td>
        </tr>
        <tr>
            <th scope="row"><?php _e('Email' , 'wp_op'); ?> :</th>
            <td><input class="wp_information_input" type="email" name="wp-info-email-author" 
            value="<?php echo htmlentities(get_option('wp-info-email-author')); ?>" disabled='disabled' /></td>
        </tr>
    </table>
