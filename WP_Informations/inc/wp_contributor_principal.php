<div class="boite">
    ...
    <table class="form-table">
        <tr>
            ...
            value="<?php echo get_option('wp-info-name-contributor'); ?>" disabled='disabled' /></td>
        </tr>
        <tr>
            ...
            value="<?php echo get_option('wp-info-twitter-contributor'); ?>" disabled='disabled' /></td>
        </tr>
        <tr>
